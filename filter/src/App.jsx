...
function App() {
  ...
  const todosOsProdutos = [
    ...
    { id: 6, nome: "Caixa de som", categoria: "Áudio", preco: 900.0 }
  ];
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.botoesFiltro}>
        <button onClick={() => setCategoriaAtiva ("Todos")}className={categoriaAtiva === "Todos" ? styles.botaoAtivo : ""}>Todos</button>
        <button onClick={() => setCategoriaAtiva("Periféricos")}className={categoriaAtiva === "Periféricos" ? styles.botaoAtivo : ""}>Periféricos</button>
        <button onClick={() => setCategoriaAtiva("Telas")}className={categoriaAtiva === "Telas" ? styles.botaoAtivo : ""}>Telas</button>
        <button onClick={() => setCategoriaAtiva("Áudio")}className={categoriaAtiva === "Áudio" ? styles.botaoAtivo : ""}>Áudio</button>
      </div>
